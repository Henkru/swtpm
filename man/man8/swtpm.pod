...
filesystem/process, package, coroutine, and debug libraries are absent. Loading,
protected-call and metatable functions are removed. Lua 5.4 C<string.pack>,
C<string.unpack>, and native bitwise operators are available for binary parsing.
...
No file I/O, dynamic loading, or additional Lua libraries are enabled.
