...
protected-call and metatable functions are removed. C<tpm.log(STRING)> provides
up to 4096 bytes of diagnostic output per call. Scripts remain trusted inputs:
